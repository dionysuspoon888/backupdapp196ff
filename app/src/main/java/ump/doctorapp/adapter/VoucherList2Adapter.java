...
public class VoucherList2Adapter extends RecyclerView.Adapter<VoucherList2Adapter.ViewHolder>{
    ...
    public VoucherList2Adapter(Context context, ArrayList<Voucher1Data> lists) {
        ctx = context;
        list = lists;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(ctx).inflate(R.layout.voucherlist2_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.statusImage.setImageResource(R.drawable.claim_history_processed);
